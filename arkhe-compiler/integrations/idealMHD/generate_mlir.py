...
if __name__ == "__main__":
    # Use relative path consistent with root dir execution in test_e2e.sh
    converter = MHDToMLIR(Path("integrations/idealMHD/specifications"), Path("integrations/idealMHD"))
