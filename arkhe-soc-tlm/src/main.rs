use arkhe_soc_tlm::{
    micros, aotb::{AotbEncoderHw, AotbVerifierHw}, soc::ArkheSoc, ClockDomain,
    PerformanceCounters, REFERENCE_SOL_US, MAX_SWARMS
};
...
fn main() {
    ...
    let per_iter_us = micros(total.qpl_cycles, freq_mhz) / iterations as f64;
    ...
    let report = Report {
        ...
        swarms_completed: iterations as u64 * MAX_SWARMS as u64,
