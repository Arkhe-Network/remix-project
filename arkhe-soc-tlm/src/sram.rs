use crate::{
    ArkhePeripheral, BufferId, DOMAIN_NODES, FULL_NODES, SocError,
};
...
impl Default for SramDxController {
    fn default() -> Self {
        Self::new()
    }
}
