...
Entropy (S = k_B ln Ω)	Formalized	Mapped	⚠️	Valid formula; Invalid entropy bounds are blocked by linter
...
INV-TUT-02: Invalid entropy claims are forbidden. Any document containing them fails CI.
...
INV-MOCK-01: Functions labeled "mock" may not be presented as physical results. They must be clearly marked as simulated placeholders.
